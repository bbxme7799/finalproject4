                        ...
                        <div className="w-full my-5 mx-5 px-5 py-5">
                            ...
                            <table className="w-full mx-auto">
                                <tbody >
                                    ...
                                    {records.filter((user) => user.service.toLowerCase().includes(query || btn)).map((item) => (
