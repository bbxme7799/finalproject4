                    ...
                    <div className="relative">
                        <div className="border-b-2 border-gray-200">
                            <ul className={styles.section}>
                                ...
                                <li className="sectionli mx-1 my-3 bg-gray-50 text-gray-500 px-5 py-2 rounded-lg " onClick={(e) => setbtn(e.target.value)} value="โปรดรอ.."><button onClick={(e) => setbtn(e.target.value)} value="โปรดรอ..">โปรดรอ..</button></li>
                        ...
                        <div className="w-full my-5 mx-5 px-5 py-5">
                            ...
                            <div className="flex justify-between mx-3 my-5 ">
                                ...
                                <label htmlFor="dropdownMenu" className="pr-4">แสดง</label>
                                <select id="dropdownMenu" name="dropdownMenu" className="mt-[0.2rem]  border-2 rounded-md py-2 px-3"  onClick={(e) => setrecordsPerPage(e.target.value)}>
                                    <option value="10">10</option>
                                    <option value="25">25</option>
                                    <option value="50">50</option>
                                </select>
                                <label htmlFor="dropdownMenu" className="pl-4 flex">แถว <p className="ml-3 opacity-70">จากทั้งหมด {Users.length} ข้อมูล</p></label>
                                </div>
