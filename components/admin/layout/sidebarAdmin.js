            ...
            <div>
              ...
              <nav class="flex-1 mt-4 space-y-1">
                ...
                >
                  ...
                  หมวดหมู่
                  <span class="text-xs uppercase ml-auto font-semibold text-indigo-600 bg-indigo-50 border border-indigo-300 rounded-full inline-flex items-center px-2 py-0.5">
                    {" "}
                    New{" "}
                  </span>
                </a> */}
